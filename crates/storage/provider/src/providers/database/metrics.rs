...
pub(crate) struct DatabaseProviderMetrics {
    ...
    /// Total serialized byte size of trie updates written per `save_blocks` call
    save_blocks_write_trie_updates_data_bytes: Histogram,
    /// Total serialized byte size of hashed state written per `save_blocks` call
    save_blocks_write_hashed_state_data_bytes: Histogram,
...
pub(crate) struct SaveBlocksTimings {
    ...
    pub trie_updates_data_bytes: usize,
    pub hashed_state_data_bytes: usize,
...
impl DatabaseProviderMetrics {
    ...
    pub(crate) fn record_save_blocks(&self, timings: &SaveBlocksTimings) {
        ...
        self.save_blocks_write_trie_updates_data_bytes
            .record(timings.trie_updates_data_bytes as f64);
        self.save_blocks_write_hashed_state_data_bytes
            .record(timings.hashed_state_data_bytes as f64);
